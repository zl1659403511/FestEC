...
import com.abc.latte.ui.recycleview.BaseDecoration;
import com.abc.latte.ui.refresh.RefreshHandler;
  ...
  /*  @OnClick(R2.id.icon_index_scan)
    ...
    private void initRecyclerView() {
        ...
        mRecyclerView.addItemDecoration
                (BaseDecoration.create(ContextCompat.getColor(getContext(), R.color.app_background), 7));
